...
\section{Education}
\cventry{}{Department of Biological Sciences}{Ph.D. Candidate in Biological Sciences}{anticipated 2021}{\textit{Auburn University}}{Advisors: Drs. Jamie Oaks \& Tonia Schwartz}  % arguments 3 to 6 can be left empty
...
\cvitemwithcomment{2017}{Meredith Birchfield Endowed Fund for Excellence (Auburn University Museum of Natural History)}{\$1500}
...
\cvitemwithcomment{2019}{Trees in the Desert Workshop (NSF - University of Arizona)}{fully funded}
...
\cvitemwithcomment{2019}{LSU Museum of Natural Science Seminar Series}{Invited Seminar}
\small{\tabto{1.25cm}Riverine barriers as drivers of biodiversification in terrestrial fauna of Southeast Asia}
\section{Guest Lectures}
\cvitemwithcomment{2021}{Scripting for Biologists (BIOL 7180)}{Guest Lecture}
\small{\tabto{1.25cm}Creating python classes and using random number generators} \\
\small{\tabto{1.25cm}Implementing regular expressions} \\
\small{\tabto{1.25cm}Introduction to Biopython} \\
\cvitemwithcomment{2019}{Vertebrate Biodiversity (BIOL 4020)}{Guest Lecture}
\small{\tabto{1.25cm}Amphibian Life History Strategies} \\
\cvitemwithcomment{2018}{Functional Genomics (BIOL 5850/6850}{Guest Lecture}
\small{\tabto{1.25cm}Using high-throughput sequencing to examine variation at targeted genomic regions} \\
\cvitemwithcomment{2018}{Evolution and Systematics (BIOL 3030}{Guest Lecture}
\small{\tabto{1.25cm}Early evolutionary ideas- Tree thinking} \\
\cvitemwithcomment{2016}{Principles of Biology}{Guest Lectures}
\small{\tabto{1.25cm}The domains of life} \\
\small{\tabto{1.25cm}The central dogma of biology} \\
...
\cvitemwithcomment{2020}{Led team of three in FL and collected 200 live \textit{Anolis sagrei} for lab breeding colony}{2 days}
...
\cvitemwithcomment{2020}{Inroduction to Discipline-Based Education Research - graduate course}{instructor: Cissy Ballen}
\cvitemwithcomment{2018}{Creating an active learning classroom - professional workshop}{host: AU Biggio Center}

\section{Assistantships}
\subsection{Auburn University}
\begin{itemize}
	\item{\cvitemwithcomment{2021}{GTA}{BIOL 7180: Scripting for Biologists}}
	\item{\cvitemwithcomment{2020}{GTA}{BIOL 4020: Vertebrate Biodiversity Lab}}
	\item{\cvitemwithcomment{2020 (summer)}{Graduate Research Assistantship (GRA)}{Phylogenetics (PI: Jamie Oaks)}}
	\item{\cvitemwithcomment{2020}{Graduate Teaching Assistantship (GTA)}{BIOL 5740/6740: Herpetology Lab}}
	\item{\cvitemwithcomment{2019}{GTA}{BIOL 4020: Vertebrate Biodiversity Lab}}
	\item{\cvitemwithcomment{2019 (summer)}{GRA}{Phylogenetics (PI: Jamie Oaks)}}
	\item{\cvitemwithcomment{2018}{GTA}{BIOL 5240/6240Animal Physiology Lab}}
	\item{\cvitemwithcomment{2017-2019}{GTA}{BIOL 5600/6600: Biomedical Physiology Lab}}
	\item{\cvitemwithcomment{2018 (summer)}{GRA}{Functional Genomics (PI: Tonia Schwartz)}}
	\item{\cvitemwithcomment{2016}{GTA}{BIOL 2501: Anatomy and Physiology Lab}}
\end{itemize}
\subsection{Brigham Young University}
\begin{itemize}
	\item{\cvitemwithcomment{2013-2016}{Undergraduate RA}{Phylogenetic Systematics (PI: Jack Sites)}}
	\item{\cvitemwithcomment{2013-2016}{URA}{Metabolic Physiology and Bioenergetics (PI: Chad Hancock)}}
	\item{\cvitemwithcomment{2013-2016}{UTA}{BIO 130: Principles of Biology (Instructors: Keoni Kauwe \& Byron Adams)}}
\end{itemize}

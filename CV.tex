...
\email{    rlk0015@auburn.edu}                               % optional, remove / comment the line if not wanted
...
\section{Education}
\cventry{}{Department of Biological Sciences}{Ph.D. Candidate in Biological Sciences}{scheduled 2022}{\textit{Auburn University}}{Advisors: Drs. Jamie Oaks \& Tonia Schwartz}  % arguments 3 to 6 can be left empty
...
\cvitemwithcomment{2022 (upcoming)}{DBS Seminar Host Chair - Brandon Ogbunu Visit (Princeton)}{Auburn University}
\cvitemwithcomment{2018-present}{Member of the Snake Response Team}{Auburn University}
